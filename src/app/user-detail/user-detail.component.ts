      ...
      @if (loading()) {
        ...
        <div class="user-card">
          ...
          <div class="actions">
            ...
            <a [routerLink]="['/user', user()!.id + 1]">Siguiente Usuario</a>
          </div>
        </div>
      } @else {
...
export class UserDetailComponent implements OnInit{
  ...
  async loadUser(id: number) {
    ...
    const mockUsers: User[] = [
      { id: 1, name: 'Leanne Graham', email: 'leanne@email.com', phone: '1-770-736-8031', website: 'hildegard.org' },
      { id: 2, name: 'Ervin Howell', email: 'ervin@email.com', phone: '010-692-6593', website: 'anastasia.net' },
